        ...
        <div className="sidebar-header-top">
          <div className="sidebar-header-text">
            <div className="sidebar-title-row">
              ...
              <h1>{portalView === 'history' ? 'PyAerial History' : 'PyAerial Live Tracker'}</h1>
            </div>
          </div>
          <div className="sidebar-header-controls">
            ...
            <div id="stats-panel" className="ui-btn-group">
              <Stat
                title={
                  portalView === 'live'
                    ? 'Aircraft currently tracked by pyaerial run'
                    : 'Completed flights archived when a retain rule held long enough'
                }
              >
        ...
        >
          {isLoadingFlights ? (
            ...
            <StatusMessage>
              {emptyFlightsMessage({
                view: portalView,
                hasFilters: Boolean(searchQuery || historySinceDate || historyUntilDate),
